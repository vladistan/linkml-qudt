...
def _(content):
    ...
    content['classes']['BaseDimensionMagnitude']['slot_usage']['vectorMagnitude']['range'] = 'float'
    content['classes']['PhysicalConstant']['slot_usage']['exactConstant']['range'] = 'boolean'

    content['classes']['Quantifiable']['slot_usage']['relativeStandardUncertainty']['range'] = 'double'
    content['classes']['Quantifiable']['slot_usage']['standardUncertainty']['range'] = 'decimal'
    content['classes']['Quantifiable']['slot_usage']['standardUncertaintySN']['range'] = 'double'
    content['classes']['Quantity']['slot_usage']['isDeltaQuantity']['range'] = 'boolean'

    content['classes']['Verifiable']['slot_usage']['wikidataMatch'] = {'required': False }
...
def _(content):
    ...
    content['description'] = 'This is a LinkML representation of the QUDT (Quantities, Units, Dimensions and Types) ontology. QUDT provides a comprehensive vocabulary for describing physical quantities, units of measure, and their relationships in a machine-readable format.'
